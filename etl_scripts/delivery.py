...
args = getResolvedOptions(sys.argv, ['JOB_NAME', 's3_location', 'file_name'])
...
#s3_location = "s3://leonardo.exalitica.com/boto3/prueba_producto_nuevo2/"
...
path_file = ath.run_query(query = query, database = "prod_jumbo", s3_output = s3_location,spark=spark)
