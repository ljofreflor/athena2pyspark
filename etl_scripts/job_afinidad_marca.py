...
df_afinidad_marca.repartition(1).write.mode("Overwrite").parquet("s3://cencosud.exalitica.com/prod/jumbo/dinamicas/afinidad_marca/")
df_afinidad_subclase.repartition(1).write.mode("Overwrite").parquet("s3://cencosud.exalitica.com/prod/jumbo/dinamicas/afinidad_subrubro/")