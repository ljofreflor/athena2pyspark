...
df_afinidad_marca.write.mode("Overwrite").parquet("s3://cencosud.exalitica.com/prod/jumbo/dinamicas/afinidad_marca/")
df_afinidad_subclase.write.mode("Overwrite").parquet("s3://cencosud.exalitica.com/prod/jumbo/dinamicas/afinidad_subrubro/")
