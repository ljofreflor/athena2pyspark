...
def get_spark_session(aws_access_key_id, aws_secret_access_key, args):
    ...
    if args['mode'] == "local":
        ...
        os.environ['PYSPARK_SUBMIT_ARGS'] = '--packages saurfang:spark-knn:0.2.0,mysql:mysql-connector-java:5.1.38,com.amazonaws:aws-java-sdk:1.11.86,org.apache.hadoop:hadoop-aws:2.7.2 pyspark-shell'
